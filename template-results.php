        ...
        <?php if(count($listings) > 0) { // count & check if has search results (listings) ?>
				...
				<?php if($listing["MLS"] != "") { ?>
                    ...
                    <div class="property_results-item" id="#<?=$n+1;?>">
                        ...
                        <div class="property_results-detail"> 
                            ...
                            <br/><?php echo number_format($listing["Bedrooms"], 0, '', ''); ?> Bedroom, <?php echo number_format($listing["Bathrooms"], 0, '', ''); ?> Bath 
            ...
            <div class="property_results-pagination">
                ...
                <?php if($total_listings > 0 && $c >= $limit) { ?>
                	<a href="index.php?pg=<?php echo $pg + 1; ?>" style="font-size:11px;">NEXT <span style="font-size:14px;">&raquo;</span></a>
           		<?php } ?>
            </div>
